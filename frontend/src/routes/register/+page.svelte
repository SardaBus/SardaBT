...
<main class="text-center lg:p-20 p-10">
    <div class="bg-yellow-200 lg:p-5 p-2 flex flex-wrap justify-around rounded-md shadow-sm shadow-black">
        <img src="SardaLogo.png" alt="" class="lg:h-48 md:h-40 sm:h-28 lg:mt-14 drop-shadow-lg hover:drop-shadow-md transition-all">
        <div>
            ...
            <form on:submit|preventDefault={handleRegister}>
                ...
                <select class="p-2 m-2 shadow-md lg:w-64 w-52" bind:value={usertype}>
                    <option value="employee">Employee</option>
                    <option value="driver">Driver</option>
                    <option value="admin">Admin</option>
                </select><br>
                <select class="p-2 m-2 shadow-md lg:w-64 w-52" bind:value={busPreference}>
